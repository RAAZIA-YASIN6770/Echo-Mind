    ...
    return (
        <div className="container" style={{ paddingBottom: '8rem', paddingTop: '2rem' }}>
            ...
            >
                ...
                />
                <div style={{ marginTop: '1rem', padding: '1rem', background: 'var(--color-surface)', borderRadius: 'var(--radius-md)', fontSize: '0.9rem', color: 'var(--color-text-secondary)' }}>
            ...
            >
                <motion.button
                    ...
                    style={{ fontSize: '1.1rem', padding: '1rem 3rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}
